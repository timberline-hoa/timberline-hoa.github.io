...
Every Owner shall have a right and easement of enjoyment in and to the Common Area which shall be appurtenant to and shall pass with the title to every Lot, subject to the following provisions:
  ...
  (a) The right of the Association to charge reasonable admission and other fees for the use of any recreation facility situated upon the Common Area; the right of the Association to limit the number of guests of Members; the right of the Association to limit the Common Areas which may be used by guests of Members; the right of the Association to impose conditions under which Common Areas may be used by Members and/or their guests;
